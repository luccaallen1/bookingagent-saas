...
const CHART_COLORS = [BRAND_COLORS.primary, BRAND_COLORS.secondary, BRAND_COLORS.success, BRAND_COLORS.warning, BRAND_COLORS.danger, BRAND_COLORS.info];
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3 p-3 bg-slate-50 rounded-lg">
              ...
              <div className="flex-1">
                <div className="text-sm font-medium">New conversation started</div>
                <div className="text-xs text-slate-600">Sarah M. asked about back pain treatment</div>
            ...
            <div className="flex items-start gap-3 p-3 bg-slate-50 rounded-lg">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-slate-600">John D. scheduled for tomorrow 2:00 PM</div>
            ...
            <div className="flex items-start gap-3 p-3 bg-slate-50 rounded-lg">
              ...
              <div className="flex-1">
                <div className="text-sm font-medium">Voice call completed</div>
                <div className="text-xs text-slate-600">8-minute consultation with Maria L.</div>
            ...
            <div className="flex items-start gap-3 p-3 bg-slate-50 rounded-lg">
              <MessageCircle className="h-4 w-4 mt-0.5 text-blue-600" />
              <div className="flex-1">
                <div className="text-sm font-medium">FAQ answered</div>
                <div className="text-xs text-slate-600">Automated response about insurance coverage</div>
...
function SettingsScreen() {
  return (
    <div className="space-y-6">
      <SectionTitle icon={Settings} title="Settings" desc="Team management and billing" />
...
function Utilization() {
  ...
  // New clinic metrics data structure
  const kpiMetrics = {
    conversations: { current: 182, change: 12, trend: "up" },
    bookings: { current: 47, change: 18, trend: "up" },
    leadsCaptured: { current: 65, change: -5, trend: "down" }
  };

  const topTopics = [
    { topic: "Back Pain", count: 62, change: 12, trend: "up" },
    { topic: "Neck Pain", count: 41, change: -5, trend: "down" },
    { topic: "Ankle Pain", count: 28, change: 32, trend: "up" },
    { topic: "Pricing", count: 22, change: 18, trend: "up" },
    { topic: "Insurance", count: 15, change: 0, trend: "flat" }
  ];

  const channelBreakdown = [
    { channel: "Voice Agent", bookings: 20, type: "Inbound" },
    { channel: "Website Chat", bookings: 14, type: "Inbound" },
    { channel: "Instagram DM", bookings: 9, type: "Inbound" },
    { channel: "SMS Link", bookings: 4, type: "Inbound" },
    { channel: "Newsletter Link", bookings: 6, type: "Outreach" },
    { channel: "SMS Campaign", bookings: 4, type: "Outreach" },
    { channel: "QR Code", bookings: 2, type: "Outreach" }
  ];
  ...
  const actionableInsights = [
    {
      id: 1,
      icon: "📈",
      title: "Ankle pain inquiries up 32%",
      data: "28 mentions (+32% vs last month)",
      recommendation: "Send newsletter or post about ankle pain",
    ...
    },
    {
      id: 2,
      icon: "📲",
      title: "Instagram DM bookings doubled this month",
      data: "9 bookings (2× last month)",
      recommendation: "Keep link in bio & promote IG Stories with booking link",
      ctaLabel: "View Guide",
      actionType: "guide"
    },
    {
      id: 3,
      icon: "📧",
      title: "Newsletter with booking link brought 6 bookings",
      data: "6 bookings from last campaign",
      recommendation: "Repeat targeted newsletters monthly",
      ctaLabel: "Create Campaign",
      actionType: "campaign"
    },
    {
      id: 4,
      icon: "🏷️",
      title: "SMS follow-up drove 4 repeat bookings",
      data: "4 bookings from SMS follow-up",
      recommendation: "Add post-visit SMS with booking link",
      ctaLabel: "Set Up SMS Campaign",
      actionType: "settings"
    }
  ];

  const conversionFunnel = [
    { stage: "Total Inquiries", count: 542, percentage: 100, dropoff: 0 },
    { stage: "Engaged", count: 387, percentage: 71, dropoff: 29 },
    { stage: "Qualified", count: 234, percentage: 43, dropoff: 28 },
    { stage: "Booked", count: 165, percentage: 30, dropoff: 13 }
  ];

  // Trending tactic for Network tab
  const trendingTactic = {
    icon: "🔥",
    title: '"Back-to-School Posture Check" SMS Campaign',
    metric: "Avg +12 bookings in 2 weeks",
    ctaLabel: "Copy Campaign Template"
  };

  // Peer insight cards for Network tab
  const peerInsights = [
    {
      id: "peer_newsletter_back",
      icon: "📧",
      title: "Peers sent newsletters about Back Pain Relief",
      metric: "Avg 6 bookings per campaign",
      ctaLabel: "Create Back Pain Newsletter",
      actionType: "campaign"
    },
    {
      id: "peer_ig_bio",
      icon: "📲",
      title: "Clinics adding chatbot link to Instagram Bio",
      metric: "Avg +4 new bookings each month",
      ctaLabel: "Add Link to IG Bio",
      actionType: "guide"
    },
    {
      id: "peer_sms_followup",
      icon: "🏷️",
      title: "Locations running SMS follow-ups after first visit",
      metric: "Avg 25% more repeat bookings",
      ctaLabel: "Set Up SMS Follow-up",
      actionType: "settings"
    },
    {
      id: "peer_posture_social",
      icon: "📈",
      title: 'Peers posting "Posture Tips" content on social media',
      metric: "3× more bot conversations than promotional-only posts",
      ctaLabel: "View Example Posts",
      actionType: "guide"
    },
    {
      id: "peer_condition_newsletter",
      icon: "📧",
      title: "Educational newsletters on 'How to Stretch for Back Pain'",
      metric: "Avg 5–8 bookings per send",
      ctaLabel: "Create Educational Newsletter",
      actionType: "campaign"
    },
    {
      id: "peer_ig_stories",
      icon: "📲",
      title: "Instagram Story swipe-ups with booking link",
      metric: "Drove 3× more IG conversations",
      ctaLabel: "Add Story Swipe-Up",
      actionType: "guide"
    },
  ];

  const industryInsights = {
    industryBookingSources: [
      { channel: "Voice Agent", percentage: 45, avgBookings: "67/month" },
      { channel: "Website Chat", percentage: 28, avgBookings: "42/month" },
      { channel: "Social Media", percentage: 18, avgBookings: "27/month" },
      { channel: "SMS Campaigns", percentage: 9, avgBookings: "14/month" }
    ],
    socialContentPatterns: [
      { type: "Educational Posts", conversionRate: "8.4%", avgFrequency: "3x/week", engagement: "High" },
      { type: "Promotional Posts", conversionRate: "5.2%", avgFrequency: "2x/week", engagement: "Medium" },
      { type: "Patient Success Stories", conversionRate: "12.1%", avgFrequency: "1x/week", engagement: "Very High" },
      { type: "Behind-the-Scenes", conversionRate: "3.8%", avgFrequency: "2x/week", engagement: "Low" }
    ],
    postingFrequencyImpact: [
      { frequency: "Daily (7x/week)", engagement: "Medium", bookingIncrease: "+8%" },
      { frequency: "Regular (3-4x/week)", engagement: "High", bookingIncrease: "+23%" },
      { frequency: "Occasional (1-2x/week)", engagement: "Low", bookingIncrease: "+5%" },
      { frequency: "Sporadic (<1x/week)", engagement: "Very Low", bookingIncrease: "-2%" }
    ],
    linkEffectiveness: [
      { location: "Instagram Bio", clickRate: "4.2%", conversionRate: "18%", bookings: "High" },
      { location: "Google Business Profile", clickRate: "8.7%", conversionRate: "24%", bookings: "Very High" },
      { location: "QR Codes (Print)", clickRate: "2.1%", conversionRate: "31%", bookings: "Medium" },
      { location: "Email Signature", clickRate: "1.8%", conversionRate: "15%", bookings: "Low" },
      { location: "Website Footer", clickRate: "0.9%", conversionRate: "12%", bookings: "Very Low" }
    ],
    outreachImpact: {
      newsletters: [
        { topic: "Condition-Based (Back Pain Tips)", openRate: "34%", bookingRate: "7.2%" },
        { topic: "Seasonal Health (Winter Wellness)", openRate: "28%", bookingRate: "4.8%" },
        { topic: "Promotional (New Services)", openRate: "22%", bookingRate: "3.1%" },
        { topic: "General Wellness", openRate: "31%", bookingRate: "5.5%" }
      ],
      smsFollowUps: [
        { type: "Appointment Reminders (24h)", responseRate: "87%", showRate: "94%" },
        { type: "Care Plan Check-ins", responseRate: "43%", rebookRate: "28%" },
        { type: "Renewal Nudges (90 days)", responseRate: "56%", rebookRate: "31%" },
        { type: "Seasonal Health Tips", responseRate: "23%", bookingRate: "8%" }
      ]
    }
  };
  ...
  const actionCards = [
    { 
      id: 1,
      title: "Address Pricing Questions",
      description: "34% of drop-offs are due to pricing questions - add clear pricing info to bot responses",
      actionType: "settings"
    },
    {
      id: 2, 
      title: "Boost Voice Agent Performance",
      description: "Voice bookings are 6% below network average - optimize voice scripts and training",
      actionType: "settings"
    },
    {
      id: 3,
      title: "Focus on Neck Pain Content",
      description: "Neck pain is your #1 condition but #2 in network - create targeted neck pain campaigns",
      actionType: "campaign"
    },
    {
      id: 4,
      title: "Leverage Instagram Strength",
      description: "Your IG performance (17%) beats network average (15%) - expand Instagram strategy",
      actionType: "campaign"
    }
  ];
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="local" className="space-y-6 mt-6">
          ...
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-lg font-semibold">Your Clinic</h3>
            <Badge variant="secondary" className="text-xs">Local Insights</Badge>
          </div>

          {/* 1. Headline KPIs */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card className="rounded-2xl shadow-sm border-0 bg-gradient-to-br from-white to-blue-50/20">
              <CardContent className="p-6">
                <div className="flex justify-between items-start">
                  <div>
                    <p className="text-sm font-medium text-slate-600">Conversations</p>
                    <p className="text-3xl font-bold text-slate-900 mt-1">{kpiMetrics.conversations.current}</p>
                  </div>
                  <div className={`flex items-center gap-1 px-2 py-1 rounded-lg text-sm font-semibold ${
                    kpiMetrics.conversations.trend === 'up' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'
                  }`}>
                    <span>{kpiMetrics.conversations.trend === 'up' ? '▲' : '▼'}</span>
                    <span>{Math.abs(kpiMetrics.conversations.change)}%</span>
                  </div>
                </div>
            ...
            <Card className="rounded-2xl shadow-sm border-0 bg-gradient-to-br from-white to-green-50/20">
              <CardContent className="p-6">
                <div className="flex justify-between items-start">
                  <div>
                    <p className="text-sm font-medium text-slate-600">Bookings</p>
                    <p className="text-3xl font-bold text-slate-900 mt-1">{kpiMetrics.bookings.current}</p>
                  </div>
                  <div className={`flex items-center gap-1 px-2 py-1 rounded-lg text-sm font-semibold ${
                    kpiMetrics.bookings.trend === 'up' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'
                  }`}>
                    <span>{kpiMetrics.bookings.trend === 'up' ? '▲' : '▼'}</span>
                    <span>{Math.abs(kpiMetrics.bookings.change)}%</span>
                  </div>
                </div>
                <p className="text-xs text-slate-500 mt-2">vs last month</p>
              </CardContent>
            ...
            <Card className="rounded-2xl shadow-sm border-0 bg-gradient-to-br from-white to-purple-50/20">
              <CardContent className="p-6">
                <div className="flex justify-between items-start">
                  <div>
                    <p className="text-sm font-medium text-slate-600">Leads Captured</p>
                    <p className="text-3xl font-bold text-slate-900 mt-1">{kpiMetrics.leadsCaptured.current}</p>
                  </div>
                  <div className={`flex items-center gap-1 px-2 py-1 rounded-lg text-sm font-semibold ${
                    kpiMetrics.leadsCaptured.trend === 'up' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'
                  }`}>
                    <span>{kpiMetrics.leadsCaptured.trend === 'up' ? '▲' : '▼'}</span>
                    <span>{Math.abs(kpiMetrics.leadsCaptured.change)}%</span>
                  </div>
                </div>
                <p className="text-xs text-slate-500 mt-2">vs last month</p>
              </CardContent>
          ...
          {/* 2. Top Topics Asked & 3. Channel Breakdown - Side by side */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {/* Top Topics Asked */}
            <Card className="rounded-3xl shadow-sm border-0 bg-gradient-to-br from-white to-slate-50/30">
              <CardHeader className="pb-4">
                <CardTitle className="text-sm font-semibold text-slate-800">Top Topics Asked</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  {topTopics.map((item, idx) => (
                    <div key={idx} className="flex items-center justify-between p-3 rounded-xl bg-slate-50/50 hover:bg-slate-100/50 transition-colors">
                      <div className="flex items-center gap-3">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className={`flex items-center gap-1 text-xs font-semibold ${
                          ...
                          item.trend === 'down' ? 'text-red-600' : 'text-slate-400'
                        }`}>
                          {item.trend === 'up' && `↑ ${item.change}%`}
                          {item.trend === 'down' && `↓ ${Math.abs(item.change)}%`}
                          {item.trend === 'flat' && 'flat'}
                        </div>
                      </div>
                    </div>
                  ))}
            ...
            {/* Channel Breakdown */}
            <Card className="rounded-3xl shadow-sm border-0 bg-gradient-to-br from-white to-green-50/30">
              <CardHeader className="pb-4">
                <CardTitle className="text-sm font-semibold text-slate-800">Channel Breakdown</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-2">
                  {channelBreakdown.map((channel, idx) => (
                    <div key={idx} className="flex items-center justify-between p-3 rounded-xl hover:bg-green-50/30 transition-colors">
                      <div className="flex items-center gap-3">
                        <span className="font-semibold text-slate-800">{channel.channel}</span>
                        <Badge 
                          variant={channel.type === 'Inbound' ? 'default' : 'secondary'}
                          className="text-xs"
                        >
                          {channel.type}
                        </Badge>
                      ...
                      <div className="flex items-center gap-2">
                        <span className="text-lg font-bold text-slate-700">{channel.bookings}</span>
                        <div className="w-20 h-2 bg-slate-200 rounded-full overflow-hidden">
                          <div 
                            className="h-full bg-gradient-to-r from-green-500 to-green-400 rounded-full"
                            style={{ width: `${(channel.bookings / 20) * 100}%` }}
                          />
                        </div>
                      </div>
                    </div>
          ...
          <div className="space-y-4">
            <h4 className="font-semibold text-sm text-slate-700 tracking-wide">ACTIONABLE INSIGHTS</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {actionableInsights.map((insight) => (
                <Card key={insight.id} className="rounded-2xl shadow-sm border-0 bg-gradient-to-br from-white to-slate-50/20">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-slate-600 mt-1">{insight.data}</p>
                        </div>
                      </div>
                      <div className="pt-2 border-t border-slate-100">
                        <p className="text-sm text-slate-700 mb-3">{insight.recommendation}</p>
                        <Button 
                          size="sm" 
                          className="w-full"
        ...
        <TabsContent value="network" className="space-y-6 mt-6">
          ...
          <div className="flex items-center gap-2 mb-4">
            ...
            <Badge variant="secondary" className="text-xs">Peer-Driven</Badge>
          </div>

          {/* Trending Banner */}
          <Card className="rounded-2xl shadow-sm border-0 bg-gradient-to-r from-orange-500 to-red-500">
            <CardContent className="p-6">
              <div className="text-white">
                <div className="flex items-center gap-2 mb-3">
                  <span className="text-2xl">{trendingTactic.icon}</span>
                  <span className="text-sm font-bold uppercase tracking-wider opacity-90">Trending Across Clinics</span>
                </div>
                <h3 className="text-xl font-bold mb-2">{trendingTactic.title}</h3>
                <p className="text-lg opacity-95 mb-4">→ {trendingTactic.metric}</p>
                <Button 
                  variant="secondary" 
                  className="bg-white text-orange-600 hover:bg-gray-100 font-bold"
                  onClick={() => handleActionClick({ actionType: 'campaign' })}
                >
                  {trendingTactic.ctaLabel}
                </Button>
              </div>
            </CardContent>
          </Card>
          ...
          {/* Peer Insight Cards */}
          <div className="space-y-4">
            <h4 className="font-semibold text-sm text-slate-700 tracking-wide">WHAT YOUR PEERS ARE DOING</h4>
            
            {/* First row of cards */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {peerInsights.slice(0, 6).map((insight) => (
                <Card key={insight.id} className="rounded-2xl shadow-sm border-0 bg-gradient-to-br from-white to-purple-50/20 hover:shadow-md transition-shadow">
                  <CardContent className="p-5">
                    <div className="space-y-3">
                      <div className="flex items-start gap-3">
                        <span className="text-2xl">{insight.icon}</span>
                        <div className="flex-1">
                          <h3 className="font-bold text-slate-800 text-sm leading-tight">{insight.title}</h3>
                        </div>
                      </div>
                      <div className="py-3 border-y border-slate-100">
                        <p className="text-sm font-semibold text-purple-600">→ {insight.metric}</p>
                      </div>
                      <Button 
                        size="sm" 
                        className="w-full"
            ...
            {/* Show more cards section */}
            {peerInsights.length > 6 && (
              <div className="pt-4">
                <h4 className="font-semibold text-sm text-slate-700 tracking-wide mb-4">MORE PEER INSIGHTS</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {peerInsights.slice(6).map((insight) => (
                    <Card key={insight.id} className="rounded-2xl shadow-sm border-0 bg-gradient-to-br from-white to-purple-50/20 hover:shadow-md transition-shadow">
                      <CardContent className="p-5">
                        <div className="space-y-3">
                          <div className="flex items-start gap-3">
